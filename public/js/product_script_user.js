...
const productDetailsaddToCart = async () => {
    try {
        const response = await fetch(`/cart/${productState.productId}/add`, {
            method: 'POST',
...
<a href="/cart" class="group py-3 px-5 border border-indigo-600 rounded-lg bg-indigo-50 text-indigo-700 font-semibold text-lg w-full flex items-center justify-center gap-2 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-indigo-300 hover:bg-indigo-100">
